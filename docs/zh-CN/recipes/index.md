...
<Columns>
  ...
  <Card title="OpenClaw for Telegram" href="/recipes/openclaw-for-telegram" icon="send">
    适合移动优先、希望随时随地可达的创始人和技术团队。目前先读英文版。
  </Card>
...
<Columns>
  <Card title="AI Executive Assistant for Founders" href="/recipes/ai-executive-assistant-for-founders" icon="briefcase-business">
    看 OpenClaw 如何把聊天、定时任务、部署告警、PR 摘要串成一个创始人工作流。目前先读英文版。
  </Card>
...
| 怎么把 OpenClaw 放进手机里随时可用？ | [OpenClaw for Telegram](/recipes/openclaw-for-telegram) | 最适合移动优先团队的控制面。 |
...
| 怎么让创始人每天早上收到一份执行摘要？ | [OpenClaw Daily Executive Brief for Founders](/recipes/openclaw-daily-executive-brief-for-founders) | 这是最容易形成日常习惯的高价值循环。 |
...
1. **先做分发入口**：通常是 [OpenClaw for Feishu](/zh-CN/recipes/openclaw-for-feishu) 或 [OpenClaw for Telegram](/recipes/openclaw-for-telegram)
