...
<Columns>
  <Card title="Send Vercel Deployment Alerts with OpenClaw" href="/zh-CN/recipes/send-vercel-deployment-alerts-with-openclaw" icon="rocket">
    把 Vercel 部署事件变成可读、可跟进的聊天通知，而不是原始 webhook 噪音。
  </Card>
  <Card title="GitHub PR Summary Bot with OpenClaw" href="/zh-CN/recipes/github-pr-summary-bot-with-openclaw" icon="git-pull-request-arrow">
...
| 怎么把部署事件变成可读告警？ | [Send Vercel Deployment Alerts with OpenClaw](/zh-CN/recipes/send-vercel-deployment-alerts-with-openclaw) | 最快落地、最容易感知价值的 webhook 场景之一。 |
| 怎么让 GitHub review 流量在聊天里变清楚？ | [GitHub PR Summary Bot with OpenClaw](/zh-CN/recipes/github-pr-summary-bot-with-openclaw) | 直接把嘈杂 PR 事件压成团队看得懂的摘要。 |
...
| OpenClaw 能不能真正做成创始人的 AI 执行助理？ | [AI Executive Assistant for Founders](/zh-CN/recipes/ai-executive-assistant-for-founders) | 这页负责讲完整产品故事，而不只是配置说明。 |
| 我想先看总览，再决定从哪页开始 | [OpenClaw Recipes](/zh-CN/recipes) | 这页就是中文总入口。 |

## 首批 8 页路由总览

如果你不想一页页慢慢读，可以先看这张总表，直接判断哪一类页面应该先上线。

| 类别 | 最值得先打开的页面 | 这类页面解决什么问题 |
| --- | --- | --- |
| Recipes Hub | [OpenClaw Recipes](/zh-CN/recipes) | 总路由页，负责把不同搜索意图快速送到正确场景页。 |
| Integrations | [OpenClaw for Feishu](/zh-CN/recipes/openclaw-for-feishu) / [OpenClaw for Telegram](/zh-CN/recipes/openclaw-for-telegram) | 先把 OpenClaw 放进团队已经在看的聊天入口。 |
| Alerting / Automation | [Send Vercel Deployment Alerts with OpenClaw](/zh-CN/recipes/send-vercel-deployment-alerts-with-openclaw) / [GitHub PR Summary Bot with OpenClaw](/zh-CN/recipes/github-pr-summary-bot-with-openclaw) | 把部署、PR 这类原始事件压缩成可读更新。 |
| Troubleshooting | [OpenClaw Cron Not Running](/zh-CN/recipes/openclaw-cron-not-running) | 定时任务失灵时先修复信任，而不是继续堆新工作流。 |
| Role / Use Case | [OpenClaw Daily Executive Brief for Founders](/zh-CN/recipes/openclaw-daily-executive-brief-for-founders) / [AI Executive Assistant for Founders](/zh-CN/recipes/ai-executive-assistant-for-founders) | 用创始人 / 运营语言讲清楚 OpenClaw 为什么值得持续使用。 |

## 如果这周只能先上线 1 页，哪一页该赢？

| 页面 | 最适合谁先做 | 典型触发问题 | 为什么优先级会高 |
| --- | --- | --- | --- |
| [OpenClaw for Feishu](/zh-CN/recipes/openclaw-for-feishu) | 飞书 / Lark 原生团队 | “我们想先把 OpenClaw 放进公司聊天里。” | 当目标是内部 adoption 时，分发入口优先级通常最高。 |
| [OpenClaw for Telegram](/zh-CN/recipes/openclaw-for-telegram) | 移动优先的创始人、技术团队 | “我想随时随地在手机里用 OpenClaw。” | 当可达性是第一需求时，Telegram 往往比继续补泛文档更值。 |
| [Send Vercel Deployment Alerts with OpenClaw](/zh-CN/recipes/send-vercel-deployment-alerts-with-openclaw) | 已有部署噪音的团队 | “部署通知太多，但没人真看。” | 这是最容易让技术团队马上感知价值的自动化场景之一。 |
| [GitHub PR Summary Bot with OpenClaw](/zh-CN/recipes/github-pr-summary-bot-with-openclaw) | review 协作混乱的工程团队 | “GitHub 通知很多，但 review 还是跟不上。” | 适合把已有协作噪音压成高信号流。 |
| [OpenClaw Daily Executive Brief for Founders](/zh-CN/recipes/openclaw-daily-executive-brief-for-founders) | 创始人 / 运营负责人 | “我想每天早上只看一条消息，知道最重要的事。” | 这是最容易形成日常使用习惯的 recurring workflow。 |
| [OpenClaw Cron Not Running](/zh-CN/recipes/openclaw-cron-not-running) | 定时任务已不稳定的任何团队 | “自动化有时跑，有时不跑，我已经不信它了。” | 可靠性问题如果不先修，后续页面再好也难转化。 |
| [AI Executive Assistant for Founders](/zh-CN/recipes/ai-executive-assistant-for-founders) | 需要完整产品叙事的 buyer | “我想知道 OpenClaw 能不能真的成为创始人的工作系统。” | 适合在分发和可靠性已有基础后，承接更高层的购买/理解意图。 |

一个简单判断规则：

1. **先做分发入口**，如果 OpenClaw 还没进入团队真正会看的聊天面。
2. **先做可靠性页**，如果定时任务已经开始掉信任。
3. **先做自动化页**，如果团队最大痛点是部署或 PR 噪音。
4. **最后补产品叙事页**，如果 buyer 需要的是“为什么值得”，不是“怎么配出来”。
